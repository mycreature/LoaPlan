            ...
            <div className='flex h-full flex-col items-center justify-start'>
              ...
              <div className='mt-4 w-[90%] space-y-[20px]'>
                <Input
                  ...
                  onBlur={(e) =>
                    !emailError ? setEmailState(e.target.value) : console.log(emailError)
                  }
                />
                {emailError && (
                ...
                <Input
                  ...
                  onBlur={(e) =>
                    !passwordError ? setPasswordState(e.target.value) : console.log(passwordError)
                  }
                />
                {passwordError && (
                  <span style={{ color: 'red', fontSize: '0.9rem' }} className='mb-3'>
              ...
              <div className='mt-8 w-[90%] space-y-[10px]'>
                <Button
                  ...
                  onClick={() => {
                    if (!emailError && !passwordError && !confirmPasswordError && !apiKeyError) {
                      setEmail(email)
