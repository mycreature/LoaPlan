...
interface RegisterFormProps {
  onSubmit: (data: LocalUserFormData) => void // 폼 제출 시 실행할 함수
  isLoading?: boolean // 로딩 상태
}

const LocalLoginForm = ({ onSubmit, isLoading = false }: RegisterFormProps) => {
  ...
  const handleFormSubmit = (data: LocalUserFormData) => {
  ...
  const handleError = (field: keyof LocalUserFormData, error: any) => {
